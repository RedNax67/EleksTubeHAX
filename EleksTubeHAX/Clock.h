...
//#define CONFIG_LWIP_SNTP_UPDATE_DELAY 900000 //Force sntp to update every 15 minutes
#define CONFIG_LWIP_SNTP_UPDATE_DELAY 15000 //Force sntp to update every 15 minutes
...
class Clock {
  public:
    ...
    void setTwelveHour(bool twelve_hour_) {
      config->twelve_hour = twelve_hour_;
    }
    bool getTwelveHour()                  {
      return config->twelve_hour;
    }
    void toggleTwelveHour()               {
    ...
    time_t getTimeZoneOffset()            {
      return config->time_zone_offset;
    }
    ...
    uint16_t getYear()       {
      return year(local_time);
    }
    uint8_t getMonth()       {
      return month(local_time);
    }
    uint8_t getDay()         {
      return day(local_time);
    }
    uint8_t getHour()        {
      return config->twelve_hour ? hourFormat12(local_time) : hour(local_time);
    }
    uint8_t getHour12()      {
      return hourFormat12(local_time);
    }
    uint8_t getHour24()      {
      return hour(local_time);
    }
    uint8_t getMinute()      {
      return minute(local_time);
    }
    uint8_t getSecond()      {
      return second(local_time);
    }
    bool isAm()              {
      return isAM(local_time);
    }
    bool isPm()              {
      return isPM(local_time);
    }
    ...
    uint8_t getHoursOnes()    {
      return getHour() % 10;
    }
    uint8_t getHours12Tens()  {
      return getHour12() / 10;
    }
    uint8_t getHours12Ones()  {
      return getHour12() % 10;
    }
    uint8_t getHours24Tens()  {
      return getHour24() / 10;
    }
    uint8_t getHours24Ones()  {
      return getHour24() % 10;
    }
    uint8_t getMinutesTens()  {
      return getMinute() / 10;
    }
    uint8_t getMinutesOnes()  {
      return getMinute() % 10;
    }
    uint8_t getSecondsTens()  {
      return getSecond() / 10;
    }
    uint8_t getSecondsOnes()  {
      return getSecond() % 10;
    }
